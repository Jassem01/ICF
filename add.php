...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo " - Nom de fichier: " . $row["file_name"];
    echo "<form action='php-file-upload-script-master/télécharger.php' method='POST'><input type='submit' name='download' value='Télécharger'></form><br>";
